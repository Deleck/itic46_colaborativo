                        ...
                        <table id="enfasis-columna">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="default" id="ocupacion" name="ocupacion" onclick="anexarOcupacion()">
                            ...
                            <tr><input type="hidden" name="id" value="${perfil.usuarioId.id}"/></tr>
                            <tr style="text-align:center">
                                <td>
                                    <input class="default" type="reset" value="Limpiar">
                                </td>
                                <td>
